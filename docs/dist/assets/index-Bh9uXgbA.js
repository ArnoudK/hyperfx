...
}`;Ce.registerLanguage("typescript",Fs);Ce.registerLanguage("html",Us);Ce.registerLanguage("bash",Hs);Ce.registerLanguage("json",Xs);const Zs=Cn(Ps);function ln(t){document.title=t}function un(t){const e=document.querySelector('meta[name="description"]');e&&e.setAttribute("content",t)}function Ws(){const t=fn(),e=Pe(()=>{const s=Hr("doc")()||"main";console.log("docname:",s);const r=bn.find(i=>i.route_name==s);return r?(ln(`${r.title} | HyperFX`),un(`HyperFX docs about ${r.title}.`)):(ln("HyperFX"),un("HyperFX docs")),r}),n=Pe(()=>{const s=e();if(s){const r=Cn(s.data);return console.log(r.slice(0,100)),r}return""});return ge(()=>{t(),setTimeout(()=>{const s=document.querySelectorAll("pre code");for(const r of s)Ce.highlightElement(r)},1)}),D(pn,{children:[A(tn,{when:()=>n,children:D("div",{class:"flex flex-auto",children:[A(Yr,{}),A("article",{class:"p-4 flex flex-col overflow-auto mx-auto w-full max-w-4xl",children:A("div",{class:"markdown-body",innerHTML:n})})]})}),A(tn,{when:()=>e()===void 0||e().route_name==="main",children:D("div",{class:"grow flex flex-col",children:[A("article",{class:"p-4 mx-auto w-full max-w-4xl",children:A("div",{class:"markdown-body-main",innerHTML:Zs})}),D("div",{class:"p-2 bg-red-950 text-white mt-4 mx-auto",children:[A("p",{class:"text-xl",children:"This is a work in progress!"}),A("p",{class:"text-xl",children:"The docs are not finished yet!"})]})]})})]})}function Ks(){const t=js(),e=A("pre",{class:"mx-auto max-w-[70vw]! max-h-[50vw]",children:A("code",{class:"language-tsx",children:qs})});return ge(()=>{setTimeout(()=>{const n=document.querySelector("pre code");n&&n.attributes.getNamedItem("data-highlighted")?.value!="yes"&&Ce.highlightElement(n)},0)}),D("div",{class:"flex flex-col p-4 max-w-[80vw] mx-auto",children:[D("div",{class:"p-2",children:[D("p",{class:"mx-auto",children:["This is the code used to create the editor.",D("span",{class:"text-purple-500/80",children:[" ","(The editor is far from done but it is still cool IMO.)"]})]}),A("div",{class:"w-full",children:e})]}),t]})}function Js(){const t=$r(),e=fn();return ge(()=>{e()==="/"&&t("/hyperfx")}),D("div",{class:"flex flex-auto flex-col min-h-screen",children:[A(Jr,{}),D("main",{class:"flex flex-auto flex-col",id:"main-content",children:[A("p",{class:"p-2 bg-red-800 text-white text-center w-full! max-w-full!",children:"A LOT OF CHANGES. DOCS ARE NOT UP TO DATE."}),A(en,{path:"/hyperfx/editor",component:Ks}),A(en,{path:"/hyperfx",component:Ws,exact:!0})]}),D("footer",{class:"bg-slate-900 mx-auto w-full min-h-12 p-4 text-center mt-auto",children:[A("a",{href:"https://github.com/ArnoudK/hyperfx",target:"_blank",class:"underline",children:"Github"}),D("span",{class:"w-full ",children:[" - © ",new Date().getFullYear()," Arnoud Kerkhof"]})]})]})}function Qs(){return A(Dr,{initialPath:"/hyperfx",children:()=>A(Js,{})})}const Ys=document.getElementById("app");Ys.replaceChildren(Qs());
