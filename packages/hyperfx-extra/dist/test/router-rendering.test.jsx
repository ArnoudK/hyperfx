...
describe("Router Rendering", () => {
  ...
  it("should render route with parameters", () => {
    const UserRoute = createRoute("/user/:userId", {
      view: (params) => <div class="user">User ID: {params.userId}</div>,
    });
  ...
  it("should render notFound component for unmatched routes", () => {
    ...
    const NotFound = ({ path }) => <div class="not-found">404: {path} not found</div>;
    const router = createRouter([HomeRoute]);
...
describe("Router Navigation", () => {
  ...
  it("should navigate programmatically between routes", () => {
    ...
    console.log("After navigate, HTML:", container.innerHTML);
  ...
  it("should navigate with route parameters", () => {
    ...
    const UserRoute = createRoute("/user/:userId", {
      view: (params) => <div class="user">User: {params.userId}</div>,
    });
  ...
  it("should handle navigation to non-existent routes", () => {
    ...
    const NotFound = ({ path }) => <div class="not-found">404: {path}</div>;
    const router = createRouter([HomeRoute]);
    const RouterComponent = router.Router;
    const App = () => (
      <div>
...
describe("Link Component", () => {
  ...
  it("should navigate when Link is clicked", () => {
    ...
    expect(container.querySelector(".home")).toBeTruthy();
    // Click the link
    const link = container.querySelector(".about-link");
    expect(link).toBeTruthy();
    link.click();
  ...
  it("should navigate to parameterized route when Link is clicked", () => {
    ...
    expect(container.querySelector(".home")).toBeTruthy();
    // Click the link
    const link = container.querySelector(".user-link");
    link.click();
    expect(container.querySelector(".user")).toBeTruthy();
    expect(container.textContent).toContain("User: alice");
  });
...
describe("Router Edge Cases", () => {
  ...
  it("should not match root route for non-root paths", () => {
    ...
    const NotFound = ({ path }) => <div class="not-found">Not Found: {path}</div>;
    const router = createRouter([HomeRoute]);
    const routerMemo = router.Router({
      initialPath: "/about",
      notFound: NotFound,
  ...
  it("should handle optional parameters", () => {
    const DocRoute = createRoute("/docs/:section?", {
      view: (params) => <div class="docs">Section: {params.section || "index"}</div>,
    });
    // Test with parameter
  ...
  it("should handle catch-all routes", () => {
    const DocsRoute = createRoute("/docs/...[slug]", {
      view: (params) => <div class="docs">Docs: {params.slug}</div>,
    });
  ...
  it("should handle empty path segments correctly", () => {
    const UserRoute = createRoute("/user/:userId", {
      view: (params) => <div class="user">User: {params.userId || "none"}</div>,
    });
    const NotFound = ({ path }) => <div class="not-found">Not Found</div>;
    const router = createRouter([UserRoute]);
    const RouterComponent = router.Router;
    const App = () => (
      <div>
...
//# sourceMappingURL=router-rendering.test.jsx.map
