...
export class CodeGenerator {
    constructor(isSSR, generateElementCode, generateSSRJSXCode, generateChildrenCode) {
        this.isSSR = isSSR;
        this.generateElementCode = generateElementCode;
        this.generateSSRJSXCode = generateSSRJSXCode;
        this.generateChildrenCode = generateChildrenCode;
