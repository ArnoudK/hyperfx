...
export class HyperFXTransformer {
    constructor(options = {}) {
        ...
        this.ssrGen = new SSRGenerator((node, context) => this.codeGen.codeFromNode(node, context), () => this.options.optimize.hydrationMarkers || false);
    }
    setSSR(ssr) {
