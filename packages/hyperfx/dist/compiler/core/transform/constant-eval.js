...
export function tryEvaluateConstant(node, options) {
    try {
...
function evaluateNode(node, options) {
    ...
    if (t.isObjectExpression(node)) {
        ...
        for (const prop of node.properties) {
            ...
            if (t.isIdentifier(prop.key) && !prop.computed) {
                ...
                const keyVal = evaluateNode(prop.key, options);
                if (keyVal === null) {
                    return null;
                }
                key = keyVal;
            }
            const value = evaluateNode(prop.value, options);
            if (value === null) {
                return null;
            }
            const wrappedValue = !Number.isNaN(Number(value)) || value === 'true' || value === 'false' || value === 'null'
...
//# sourceMappingURL=constant-eval.js.map