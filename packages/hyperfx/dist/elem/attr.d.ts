...
export type TargetValues = "_self" | "_blank" | "_parent" | "_top" | "_unfencedTop";
 ...
 */
export type RoleAttribute = "alert" | "alertdialog" | "application" | "article" | "banner" | "button" | "cell" | "checkbox" | "columnheader" | "combobox" | "complementary" | "contentinfo" | "dialog" | "directory" | "document" | "feed" | "figure" | "form" | "grid" | "gridcell" | "group" | "heading" | "img" | "link" | "list" | "listbox" | "listitem" | "log" | "main" | "marquee" | "math" | "menu" | "menubar" | "menuitem" | "menuitemcheckbox" | "menuitemradio" | "navigation" | "none" | "note" | "option" | "presentation" | "progressbar" | "radio" | "radiogroup" | "region" | "row" | "rowgroup" | "rowheader" | "scrollbar" | "search" | "searchbox" | "separator" | "slider" | "spinbutton" | "status" | "switch" | "tab" | "table" | "tablist" | "tabpanel" | "term" | "textbox" | "timer" | "toolbar" | "tooltip" | "tree" | "treegrid" | "treeitem";
/**
 ...
 */
export type AutocompleteStandard = "on" | "off" | "name" | "honorific-prefix" | "given-name" | "additional-name" | "family-name" | "honorific-suffix" | "nickname" | "email" | "username" | "new-password" | "current-password" | "organization-title" | "organization" | "street-address" | "address-line1" | "address-line2" | "address-line3" | "address-level4" | "address-level3" | "address-level2" | "address-level1" | "country" | "country-name" | "postal-code" | "cc-name" | "cc-given-name" | "cc-additional-name" | "cc-family-name" | "cc-number" | "cc-exp" | "cc-exp-month" | "cc-exp-year" | "cc-csc" | "cc-type" | "transaction-currency" | "transaction-amount" | "language" | "bday" | "bday-day" | "bday-month" | "bday-year" | "sex" | "tel" | "tel-country-code" | "tel-national" | "tel-area-code" | "tel-local" | "tel-extension" | "impp" | "url" | "photo" | "one-time-code";
/**
...
export interface LinkAttributes {
    href: string;
    target: TargetValues | string;
    rel: "alternate" | "author" | "bookmark" | "external" | "help" | "license" | "next" | "nofollow" | "noreferrer" | "noopener" | "prev" | "search" | "tag" | string;
    hreflang: string;
    type: string;
 ...
 */
export type ElementAttributes = Prettify<GlobalAttr & Partial<EventHandlers> & Partial<Omit<FormAttributes, 'type'> & Omit<InputAttributes, 'type'> & Omit<LinkAttributes, 'type'> & Omit<MediaAttributes, 'type'> & TableAttributes & Omit<ButtonAttributes, 'type'> & SelectAttributes & OptionAttributes & LabelAttributes & TextAreaAttributes & VideoAudioAttributes & IFrameAttributes> & {
 ...
 */
export type AttributesForElement<T extends keyof HTMLElementTagNameMap> = T extends 'input' ? InputElementAttributes : T extends 'form' ? FormElementAttributes : T extends 'a' ? LinkElementAttributes : T extends 'img' ? StrictImageAttributes : T extends 'video' | 'audio' ? VideoAudioElementAttributes : T extends 'button' ? ButtonElementAttributes : T extends 'select' ? SelectElementAttributes : T extends 'option' ? OptionElementAttributes : T extends 'label' ? LabelElementAttributes : T extends 'textarea' ? TextAreaElementAttributes : T extends 'iframe' ? IFrameElementAttributes : T extends 'td' | 'th' | 'table' | 'tr' | 'thead' | 'tbody' | 'tfoot' ? TableElementAttributes : ElementAttributes;
...
export type StrictImageAttributes = Prettify<GlobalAttr & Partial<EventHandlers> & Partial<MediaAttributes> & {
    src: string;
    alt: string;
}>;
export type StrictLinkAttributes = Prettify<GlobalAttr & Partial<EventHandlers> & Partial<LinkAttributes> & {
    href: string;
}>;
export type StrictFormAttributes = Prettify<GlobalAttr & Partial<EventHandlers> & Partial<FormAttributes> & {
    action: string;
}>;
/**
* Set with boolean attributes
*/
export declare const booleanAttrs: Set<string>;
export {};
