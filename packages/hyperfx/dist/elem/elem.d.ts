...
export declare const Div: (attributes: GlobalAttr, ...children: BodyChild[]) => HTMLDivElement;
...
export declare function addChildren(e: Element, children: (Element | Text)[]): void;
export declare function createS<K extends keyof HTMLElementTagNameMap>(name: K, attributes: object): HTMLElementTagNameMap[K];
export declare function createE<K extends keyof HTMLElementTagNameMap>(name: K, attributes: object, children: (Text | Element)[]): HTMLElementTagNameMap[K];
export {};
