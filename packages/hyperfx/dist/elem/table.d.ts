...
export declare const TableData: (attributes: GlobalAttr, ...children: readonly (HTMLElement | Text)[]) => HTMLTableCellElement;
export declare const Td: (attributes: GlobalAttr, ...children: readonly (HTMLElement | Text)[]) => HTMLTableCellElement;
...
export declare const TableHeader: (attributes: tableHeaderAttributes, ...children: readonly (Text | HTMLElement)[]) => HTMLTableCellElement;
export declare const Th: (attributes: tableHeaderAttributes, ...children: readonly (Text | HTMLElement)[]) => HTMLTableCellElement;
export declare const TableCaption: (attributes: GlobalAttr, ...children: readonly (Text | HTMLElement)[]) => HTMLTableCaptionElement;
export {};
