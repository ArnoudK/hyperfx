...
export function handleReactiveValue(element, key, value, setter) {
    try {
        if (isSignal(value)) {
            ...
            const isComputed = typeof value.destroy === 'function';
            if (isComputed) {
                addElementComputedSignal(element, value);
            }
            const update = () => {
                try {
 ...
 */
export function addElementSubscription(element, unsubscribe) {
 ...
 */
export function addElementComputedSignal(element, computed) {
