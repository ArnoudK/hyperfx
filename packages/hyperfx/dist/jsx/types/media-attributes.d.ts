...
export type MediaType = 'application/vnd.apple.mpegurl' | 'application/dash+xml' | 'application/x-mpegurl' | 'video/mp4' | 'video/webm' | 'video/ogg' | 'audio/mp4' | 'audio/webm' | 'audio/ogg' | 'audio/mpeg' | 'audio/wav' | string;
