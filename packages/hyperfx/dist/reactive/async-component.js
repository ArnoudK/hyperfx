 ...
 * ```
 */
export function createAsyncComponent(fn, options = {}) {
    const { deferStream = false } = options;
    ...
    return (props) => {
        ...
        const runStream = (forceRefresh = false) => {
            ...
            streamCleanup = runEffectFork(Stream.runForEach(stream, (jsxElement) => Effect.sync(() => {
