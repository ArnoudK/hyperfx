 ...
 */
export function isInsideEffect() {
    return insideEffect;
}
/**
 ...
 */
export function pushLifecycleContext(isEffectContext = false) {
    const context = {
        cleanups: new Set(),
...
export function onMount(fn) {
    ...
    if (insideEffect) {
        throw new Error('onMount cannot be called inside createEffect. ' +
...
export function onCleanup(fn) {
    const context = getCurrentContext();
    if (!context) {
        throw new Error('onCleanup must be called within a component or effect. ' +
 ...
 */
export function setInsideEffect(value) {
    insideEffect = value;
