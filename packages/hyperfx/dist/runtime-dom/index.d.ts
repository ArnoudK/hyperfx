 ...
 */
export declare function insert(parent: Node, accessor: (() => any) | any, marker?: Node | null, init?: any): any;
/**
 * Spread attributes onto an element
 */
export declare function spread<T extends Element>(element: T, accessor: () => Record<string, any>, isSVG?: boolean, skipChildren?: boolean): void;
/**
 ...
 */
export declare function assign<T extends Element>(element: T, prop: string, value: any): void;
/**
 * Set a property on an element with special handling for common attributes
 */
export declare function setProp<T extends Element>(element: T, prop: string, value: any): void;
/**
 ...
 */
export declare function show<T, U>(parent: Node, condition: () => boolean, whenTrue: () => T, whenFalse: () => U, marker?: Node | null): void;
/**
