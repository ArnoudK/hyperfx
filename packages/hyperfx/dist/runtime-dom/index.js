 ...
 */
function insertArray(parent, array, _current, marker) {
    const normalized = [];
 ...
 */
export function spread(element, accessor, isSVG, skipChildren) {
 ...
 */
function setupDelegation(eventName) {
 ...
 */
export function delegate(element, eventName, handler) {
 ...
 */
export function undelegate(element, eventName) {
 ...
 */
export function assign(element, prop, value) {
    if (prop in element) {
        element[prop] = value;
    }
    else {
 ...
 */
export function setProp(element, prop, value) {
 ...
 */
export function mapArray(parent, accessor, mapFn, marker) {
    let nodes = [];
    const stop = createEffect(() => {
 ...
 */
export function mapArrayKeyed(parent, accessor, mapFn, keyFn, marker) {
    // Track items by key
 ...
 */
export function forLoop(parent, accessor, mapFn, options, marker) {
    let nodes = [];
    const stop = createEffect(() => {
        const newItems = accessor();
        // Handle empty array
 ...
 */
export function findMarker(root, markerId) {
    ...
    const walker = document.createTreeWalker(root, 128, null);
