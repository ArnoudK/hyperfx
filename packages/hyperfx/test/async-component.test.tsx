...
import { createAsyncComponent } from '../src/reactive/async-component'
import { createSignal, Signal } from '../src/reactive/signal'
...
describe('createAsyncComponent (Stream-based)', () => {
  ...
  it('should provide refetch functionality via injected props', async () => {
    ...
    const element = AsyncComponent({ userId: '123' })
    document.body.appendChild(element)
