...
import { createResource, createLazyResource, createResourceFn, combineResources } from '../src/reactive/resource'
...
describe('createResourceFn', () => {
  it('should create parameterized resource', async () => {
    ...
    if (RS.isSuccess(user1()) && RS.isSuccess(user2())) {
