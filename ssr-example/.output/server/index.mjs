...
const assets = {
  "/style.css": {
    ...
    "mtime": "2026-01-30T16:18:23.918Z",
    "size": 23,
    "path": "../public/style.css"
  },
  "/assets/client-BH8XFrGr.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": '"8fa3-5HvOcDT+O3xZbGTcUXLjGkYE3uM"',
    "mtime": "2026-01-30T16:18:23.930Z",
    "size": 36771,
    "path": "../public/assets/client-BH8XFrGr.js"
  }
};
...
const _POIlxo = defineHandler((event) => {
...
const _lazy_YLw2i4 = defineLazyEventHandler(() => Promise.resolve().then(function() {
  return ssrRenderer$1;
}));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_YLw2i4 };
  return ((_m, p) => {
    return { data, params: { "_": p.slice(1) } };
  });
})();
const globalMiddleware = [
  toEventHandler(_POIlxo)
].filter(Boolean);
